...
const Header = () => {
    return (
        <header className="flex items-center justify-between bg-[#b66a47] px-3 py-3 shadow-lg">
            <div className="flex items-center gap-4">
                ...
                />
                <h1 className="text-3xl font-bold lobster-regular drop-shadow-md coffee-heading">
                    Digital Menu
                </h1>
