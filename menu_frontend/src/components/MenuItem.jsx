...
const MenuItem = ({ name, photo, description, price, veg, section, chefspecial, available=true }) => {
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className='flex-1'>
            <div className='flex items-center gap-2'>
              ...
              {chefspecial ===true && <img src={chef_icon} alt="chef's special" className='w-5 h-5' />}
              {available===false && <p className='text-gray-400'>(Not Available)</p> }
            </div>
